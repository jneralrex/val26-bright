...
const WORD_PUZZLES = [
  { word: 'BABE', hint: 'what is the name I love to call you most?' },
  { word: 'HEART', hint: 'Where would you like that I keep you' },
];

const SHAME_MESSAGES = [
  '🤦 Shame on you! Try again!',
  '😅 Nope! Think harder, my love!',
  '😂 Ohhh no! Almost there!',
  '🙈 Not quite... you got this!',
  '💔 That\'s not it... but I still love you!',
  '😜 Wrong answer, silly!',
...
const SUCCESS_MESSAGES = [
  'Nicee, you are doing well',
  'Sharpppp I am proud of you',
];
...
const PasswordPage = ({ onSuccess }) => {
  ...
  function shuffleLetters(word) {
    ...
    const combined = [...allLetters, ...extraLetters.filter(() => Math.random() > 0.5)].slice(0, 8);
